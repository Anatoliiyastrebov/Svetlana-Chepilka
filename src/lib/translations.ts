...
export const translations = {
  ru: {
    ...
    // DSGVO
    dsgvoConsent: 'Я даю свое добровольное согласие на обработку моих персональных данных в соответствии с Законом о конфиденциальности потребителей Калифорнии (CCPA) и применимыми законами США о конфиденциальности для целей предоставления консультации по здоровью. Я понимаю, что консультация не является медицинской услугой. Я знаю, что могу отозвать свое согласие в любое время и реализовать свои права на конфиденциальность в соответствии с CCPA.',
